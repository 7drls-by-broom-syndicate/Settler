        ...
        new mobarchetype("@snake","sword",40,false,true,Etilesprite.UNITS_PLAYER,//name,attackname, hp,hostile to player, hostile to enemy,tile
           ...
           1,4,0, //attacklow,high,defence
            ...
            1,false,false,2,1//sightradius,tank?,parry?,#moves,#attacks
             ...
             new mobarchetype("Barb. Scout","penknife",2,true,false,Etilesprite.UNITS_ENEMY_SCOUT,//name,attackname, hp,hostile to player, hostile to enemy,tile
            0,1,// upkeep gold,food,
            50,0,0,// buildcost production,iron,horses
            1,2,0, //attacklow,high,defence
            3,false,false,1,1//sightradius,tank?,parry?,#moves,#attacks
            ),
           new mobarchetype("Barb. Clubber","club",8,true,false,Etilesprite.UNITS_ENEMY_CLUBBER,//name,attackname, hp,hostile to player, hostile to enemy,tile
            0,2,// upkeep gold,food,
            100,0,0,// buildcost production,iron,horses
            1,4,0, //attacklow,high,defence
            1,false,false,1,1//sightradius,tank?,parry?,#moves,#attacks
            ),
            new mobarchetype("Barb. Spearman","spear",8,true,false,Etilesprite.UNITS_ENEMY_SPEARMAN,//name,attackname, hp,hostile to player, hostile to enemy,tile
            0,3,// upkeep gold,food,
            100,0,0,// buildcost production,iron,horses
            1,6,0, //attacklow,high,defence
            1,false,false,1,1//sightradius,tank?,parry?,#moves,#attacks
            ),
             new mobarchetype("Barb. Knight","sword",20,true,false,Etilesprite.UNITS_ENEMY_KNIGHT,//name,attackname, hp,hostile to player, hostile to enemy,tile
            0,5,// upkeep gold,food,
            400,10,0,// buildcost production,iron,horses
            2,8,2, //attacklow,high,defence
            1,false,false,1,1//sightradius,tank?,parry?,#moves,#attacks
            ),
             new mobarchetype("Barb. Pikeman","pike",12,true,false,Etilesprite.UNITS_ENEMY_PIKEMAN,//name,attackname, hp,hostile to player, hostile to enemy,tile
            0,5,// upkeep gold,food,
            300,8,0,// buildcost production,iron,horses
            3,9,0, //attacklow,high,defence
            1,false,false,1,1//sightradius,tank?,parry?,#moves,#attacks
            ),
            new mobarchetype("Barb. Mounted Clubber","club",10,true,false,Etilesprite.UNITS_ENEMY_MOUNTED_CLUBBER,//name,attackname, hp,hostile to player, hostile to enemy,tile
            0,8,// upkeep gold,food,
            400,8,0,// buildcost production,iron,horses
           1,4,0, //attacklow,high,defence
            1,false,false,2,1//sightradius,tank?,parry?,#moves,#attacks
            ),
            new mobarchetype("Barb. Mounted Knight","sword",22,true,false,Etilesprite.UNITS_ENEMY_MOUNTED_KNIGHT,//name,attackname, hp,hostile to player, hostile to enemy,tile
            0,8,// upkeep gold,food,
            500,10,10,// buildcost production,iron,horses
            2,8,2, //attacklow,high,defence
            1,false,false,2,1//sightradius,tank?,parry?,#moves,#attacks
